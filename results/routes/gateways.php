 ...
 * *Variables*
 * 
 * - mdl : \OPNsense\Routing\Gateways
 *     An instance of the Gateways class.
 * - gateways : array
 *     An array containing the list of gateways.
 * - ret : array
 *     An array to store the result.
 * - opts : array
 *     An array containing the parsed command-line options.
 * - args : array
 *     An array containing the remaining command-line arguments.
 * 
 * *Options*
 * 
