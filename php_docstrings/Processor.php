 ...
 * *Flow*
 * 
 * 1. Initializes the processor RRD type with the given filename
 * 2. Adds the 'user', 'nice', 'system', 'interrupt', and 'processes' datasets to the RRD type with a GAUGE type
 * 
 * *Outputs*
 * 
 * - None
