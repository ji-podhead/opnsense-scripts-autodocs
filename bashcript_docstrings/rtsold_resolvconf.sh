...
#
# This script is invoked by rtsold when a Router Advertisement with RDNSS  and DNSSL options is received. It extracts the interface, router, and DNS information from the arguments and STDIN.
#
# *Params*
#  - ${1} : str
#       - Action: 
