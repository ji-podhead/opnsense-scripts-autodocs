 ...
 * 2. Converts the interface name to a friendly name
 * 3. Checks if the interface is bound to a PPP connection
 * 4. Checks if the family of the IP address is correct
 * 5. Configures the DHCPv6 connection for the interface, if the family is 6
 * 6. Configures the static IPv6 address for the interface, if the family is 6
 * 7. Configures the routing table for the interface
 * 
 * *Outputs*
 * 
